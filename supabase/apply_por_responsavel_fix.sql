-- Aplicar imediatamente no SQL Editor do Supabase
-- Corrige o gráfico "Pedidos por responsável": usa assigned_to com fallback para created_by
...
BEGIN
  ...
  -- PEDIDOS POR RESPONSÁVEL: nome (full_name ou prefixo do email capitalizado)
  por_responsavel AS (
    SELECT
      COALESCE(
